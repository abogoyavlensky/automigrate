...
make migration for it and migrate db schema. Let's do it step by step.
...
Second element required and must be a keyword of available index types:
...
- [ ] Correctly handling of model/field renaming.
